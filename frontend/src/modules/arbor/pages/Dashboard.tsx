  ...
  return (
    <div className="px-4 pt-12 pb-4">
      <div className="flex justify-between items-start mb-6">
        ...
        {isOwner() && (
          <button onClick={() => nav('/trees/new')} aria-label="Add new tree" className="w-11 h-11 bg-forest-600 rounded-2xl flex items-center justify-center shadow-lg active:scale-95 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest-500 focus-visible:ring-offset-2">
