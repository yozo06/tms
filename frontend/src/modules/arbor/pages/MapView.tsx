        ...
        {selected && (
          <div className="absolute bottom-4 left-4 right-4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100">
            ...
            <div className="flex gap-2 mt-3">
              ...
              <button onClick={() => setSelected(null)} aria-label="Dismiss" className="w-10 h-9 border border-gray-200 rounded-xl text-gray-400 flex items-center justify-center">✕</button>
            </div>
          </div>
        )}
      </div>
