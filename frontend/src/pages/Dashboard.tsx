    ...
    <div className="px-4 pt-12 pb-4">
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-800 mt-2">Welcome, {user?.name.split(' ')[0]}</h1>
        </div>
        {isOwner() && (
          <button onClick={() => nav('/trees/new')} className="w-10 h-10 bg-forest-600 rounded-2xl flex items-center justify-center shadow-lg active:scale-95 transition-transform mt-1">
