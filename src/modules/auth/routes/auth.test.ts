...
const {
    mockFrom, mockSingle, mockEqForSelect, mockSelectChain, mockInsertSelect, mockInsertChain,
    mockComparePassword, mockSignToken, mockSignRefreshToken, mockVerifyToken, mockHashPassword,
} = vi.hoisted(() => {
