/**
 * 🌸 WildArc Bloom — Generation Engine
 *
...
export async function generate(request: GenerationRequest): Promise<GenerationResult> {
  ...
  console.log(`\n🌸 WildArc Bloom — Content Generator`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  ...
  if (isMultiSlide && template.slidePrompts?.length) {
    ...
    for (let attempt = 1; attempt <= config.maxRetries + 1; attempt++) {
      try {
        ...
        // Detect billing/free-tier quota errors — retrying won't help, bail immediately
        if (isBillingError(lastError)) {
          ...
          console.error(`  → Enable billing at: https://aistudio.google.com/plan\n`);
          break; // No point retrying Gemini — escalate to browser-based fallback in scheduler
        }
  ...
  // Print summary
  console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`✅ Bloom generation complete!`);
 ...
 * These errors cannot be resolved by retrying — billing must be enabled.
 */
